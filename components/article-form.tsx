...
type CustomerOption = { id: string; customer_code: string | null; first_name: string; last_name: string; email: string | null }
      ...
      <section className="article-form-section">
        ...
        {saleEnabled && (
          <div className="sale-inline-grid">
            <label>ID cliente<input list="article-customer-options" type="text" name="sale_customer_code" placeholder="Nome, cognome o codice cliente" required /><datalist id="article-customer-options">{customers.map((customer) => <option key={customer.id} value={customer.customer_code || ''}>{customer.first_name} {customer.last_name}{customer.email ? ` — ${customer.email}` : ''}</option>)}</datalist></label>
