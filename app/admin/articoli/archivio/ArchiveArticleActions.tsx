...
export default function ArchiveArticleActions({ articles, registerArrival, registerSale, updateSelectedArticles, deleteSelectedArticles }: Props) {
      ...
      <div className="articles-table-wrapper">
        <table className="articles-table">
          ...
          <tbody>{articles.map((a) => <tr key={a.id}>
            ...
            <td>{a.series || '—'}</td>
            <td><div className="article-detail-cell"><strong>{a.detail || '—'}</strong><small>{[a.seller, a.origin, a.notes].filter(Boolean).join(' · ') || '—'}</small></div></td>
