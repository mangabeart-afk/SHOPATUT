      ...
      {hasSelection && (
        <div className="selected-operation-panel">
          <div>
            ...
            <p>
              Per registrare una vendita inserisci il
              codice cliente, la quantità e il prezzo.
            </p>
          </div>
                ...
                <tr key={article.id}>
                  ...
                  <td>
                    <a
                      ...
                      aria-label={`Visualizza immagine ${article.article_code}`}
                    >
                      🔍
                    </a>
                  </td>
