    ...
    <main className="shell">
      ...
      <section className="content">
        ...
        <section className="panel">
          ...
          <ArticleForm action={createArticle} customers={(customerOptions || []) as any} />
        </section>

        {/* FILTRI */}

        <section className="panel article-archive-section">
        ...
        <section className="panel">
          ...
          >
            <label>
              ...
              <input list="article-sale-customer-options" type="text" name="customer_code" required placeholder="Nome, cognome o codice cliente" autoComplete="off" />
              <datalist id="article-sale-customer-options">{(customerOptions || []).map((customer: any) => <option key={customer.id} value={customer.customer_code || ''}>{customer.first_name} {customer.last_name}{customer.email ? ` — ${customer.email}` : ''}</option>)}</datalist>
            </label>
