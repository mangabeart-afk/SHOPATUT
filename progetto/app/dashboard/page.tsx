      ...
      <section className="content">
        ...
        <section className="panel">
          <div className="section-heading">
            ...
            <span className="muted">Ultimi 10 articoli caricati</span>
          </div>
            ...
            <div className="incoming-gallery">
              {incomingArticles.map((article) => (
                <div className="incoming-card" key={article.id}>
                  {article.photo_url ? (
                    <a href={article.photo_url} target="_blank" rel="noreferrer" className="incoming-photo" title="Visualizza immagine">
                      <img src={article.photo_url} alt={article.detail || article.series || article.article_code} />
                    </a>
                  ) : (
                    <div className="incoming-photo incoming-photo-empty">Nessuna foto</div>
                  )}
                  <div className="incoming-info">
                    <strong>{article.article_code}</strong>
                    {article.series && <span>Serie: {article.series}</span>}
                    {article.detail && <span>Dettaglio: {article.detail}</span>}
                    <b>IN ARRIVO</b>
                  </div>
                </div>
              ))}
